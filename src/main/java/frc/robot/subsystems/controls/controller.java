...
public class controller {
    public static void initTeleop() {
        ...
        new JoystickButton(ControlMap.DRIVER_BUTTONS, 2).onTrue(new RollerIntake(-0.2));
        new JoystickButton(ControlMap.DRIVER_BUTTONS, 2).onFalse(new RollerIntake(0));

        new JoystickButton(ControlMap.DRIVER_BUTTONS, 4).onTrue(new ArmExtension(0.2));
    }
}
